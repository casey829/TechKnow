...
topic_model = quiz_ns.model(
    "Topic",
    {
        "id": fields.Integer(
            readOnly=True, description="The unique identifier of a topic"
        ),
        "name": fields.String(required=True, description="The name of the topic"),
        "image_url": fields.String(
            required=True, description="The image URL of the topic"
        ),
        "description": fields.String(
            required=True, description="The description of the topic"
        ),
    },
)

question_model = quiz_ns.model(
    "Question",
    {
        "id": fields.Integer(
            readOnly=True, description="The unique identifier of a question"
        ),
        "topic_id": fields.Integer(required=True, description="The ID of the topic"),
        "question_text": fields.String(
            required=True, description="The text of the question"
        ),
        "answer": fields.String(
            required=True, description="The answer to the question"
        ),
    },
)

score_model = quiz_ns.model(
    "Score",
    {
        "id": fields.Integer(
            readOnly=True, description="The unique identifier of a score"
        ),
        ...
        "score": fields.Integer(
            required=True, description="The score achieved by the user"
        ),
    },
)

answer_model = quiz_ns.model(
    "Answer",
    {
        ...
        "answer": fields.String(
            required=True, description="The answer provided by the user"
        ),
    },
)

submit_model = quiz_ns.model(
    "Submit",
    {
        "user_id": fields.Integer(required=True, description="The ID of the user"),
...
class QuizSubmission(Resource):
    ...
    def post(self):
        ...
        for answer_data in answers:
            ...
            answer = Answer(
                submit_id=submission.id, question_id=question_id, answer=user_answer
            )
